...
- [ ] 读 [docs/README.md](../README.md) 定位文档；背景从 [design/project-book.md](docs/project-book.md)（项目定位）与 [design/execution-model.md](docs/maintainer/design/execution-model.md)（执行模型）入手
