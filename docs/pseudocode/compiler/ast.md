...
| 后缀整数 i8 | T_INT_I8 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 i16 | T_INT_I16 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 i32 | T_INT_I32 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 i64 | T_INT_I64 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u8 | T_INT_U8 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u16 | T_INT_U16 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u32 | T_INT_U32 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u64 | T_INT_U64 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀浮点数 f32 | T_FLOAT_F32 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀浮点数 f64 | T_FLOAT_F64 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
...
| 宽度 I8 | W_I8 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 I16 | W_I16 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 I32 | W_I32 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 I64 | W_I64 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U8 | W_U8 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U16 | W_U16 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U32 | W_U32 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U64 | W_U64 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 F32 | W_F32 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 F64 | W_F64 | （全局常量节） ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 整数类型 | TY_INT | （全局常量节） |
...
>
> **2026-09-10 R1 更新（语言面收窄 §2）**：宽度后缀已退役——lexer 对数字字面量的字母后缀一律**响亮报错**，下列 77~86 类别**不再被任何路径发射**，编号保留勿复用（`ast.cr` 墓碑注释在案，commit ce3e541c）。

| 常量 | 数值 | 含义 |
|------|------|------|
| 后缀整数 i8（T_INT_I8） | 77 | i8 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 i16（T_INT_I16） | 78 | i16 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 i32（T_INT_I32） | 79 | i32 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 i64（T_INT_I64） | 80 | i64 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u8（T_INT_U8） | 81 | u8 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u16（T_INT_U16） | 82 | u16 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u32（T_INT_U32） | 83 | u32 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀整数 u64（T_INT_U64） | 84 | u64 后缀整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀浮点数 f32（T_FLOAT_F32） | 85 | f32 后缀浮点数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 后缀浮点数 f64（T_FLOAT_F64） | 86 | f64 后缀浮点数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
...
>
> **2026-09-10 R1 更新（语言面收窄 §2）**：`W_I8..W_F64`（1..10）随宽度后缀退役一并删除——数字字面量节点的 `data` 槽**恒 0**（`parser.cr` 宽度分支已清，commit ce3e541c）。宽度 = 机器形状，归映射层。

| 常量 | 数值 | 含义 |
|------|------|------|
| 宽度 I8（W_I8） | 1 | 有符号 8 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 I16（W_I16） | 2 | 有符号 16 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 I32（W_I32） | 3 | 有符号 32 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 I64（W_I64） | 4 | 有符号 64 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U8（W_U8） | 5 | 无符号 8 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U16（W_U16） | 6 | 无符号 16 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U32（W_U32） | 7 | 无符号 32 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 U64（W_U64） | 8 | 无符号 64 位整数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 F32（W_F32） | 9 | 32 位浮点数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
| 宽度 F64（W_F64） | 10 | 64 位浮点数 ——已删除（2026-09-10 R1 语言面收窄 §2；编号保留勿复用） |
...
- 词法单元种类5（TK05）（EC_TK_SLICE_BOUNDS = 10005）：切片起点超出范围
