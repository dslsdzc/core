...
| 原引用 | 位置 | 改写为 | 依据 |
|---|---|---|---|
| `B1/T8` | S-D §5 S-D3 判据⑤ | **A 线 M1**（门禁口径一律引 R2 §4 该行） | 该处语义 = A 线 M1 的修法 |
