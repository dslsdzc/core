...
| 代 | 格式 | 值（语料 A / B × 口径 ①②） | 出处（`file:line`） |
|---|---|---|---|
| 旧 | v8（NOD **36B**） | `ptr_arith` 90823B `fb4a3b59…` / 90966B `592afa31…`；`generics_test` 134701B `cafb4278…` / 134844B `ec8413ec…` | `docs/superpowers/plans/2026-09-12-r2-p4-carrier.md` **附录 D-1 表**（P4 T7 收官实测；T7 复测逐条复现）· `TODO.md:474`（两口径表）· `TODO.md:521`（P5 T7 复验：90823 `fb4a3b59` / 90966 `592afa31` / 135341 `ddec1ce6` / 135484 `cd2af565`）· `TODO.md:376`（P5 T5-era） |
| **新（现行）** | v9（NOD **40B**） | `ptr_arith` **96015** `680a6f98…` / **96158** `76f36e6a…`；`generics_test` **142793** `41e9d845…` / **142936** `704316c8…` | `.superpowers/sdd/p6-task3-report.md:62`（**P6 T3 重锁**，逐条带「原 …」括注 + delta 归因）· `.superpowers/sdd/p6-task4-report.md:81`（T4 复验四条逐字节同）· 本表 §1.2 |
...
> **非可选程序的冷≠热是预存面**（pre-P4 二进制同病 89086/88954）并被**豁免**（TODO #5 末条家族）
