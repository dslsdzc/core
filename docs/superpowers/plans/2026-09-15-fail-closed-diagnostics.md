...
**三、剩余登记面**：**TODO #2026-09-15-5**（缓存静默缺陷 + runner 暖态腿建议——**独立批候选**，维护者已采信）· **环境干扰事件**（12 个 tracked `D`，**待维护者处置**，不得擅自还原）· 豁免表 9 条的**退出条件**（逐条在表内；撤条须带根因证据、加条须维护者批）· T3 报告面约定注（P21/TU03 不在报告行）。
