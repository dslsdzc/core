...
| — | `#2026-09-17-16` | 2026-09-17 | 并发模型规格 G8 裁定 | 【语言面·零语义存量】`move` 关键字删除（独立小批） |
| — | `#2026-09-17-17` | 2026-09-17 | 并发模型规格 G3 裁定 | ⚠⚠【静默·安全网失效】`ptr_analysis` 全程序 alloc 追踪上限 64（第 65 个起静默不追踪）+ 计数器从不复位 |
| — | `#2026-09-17-18` | 2026-09-17 | 并发模型规格 §15.5 实读 | 文档/注释漂移三处（`#2026-07-31-1` offset 56 注记过时 · `ptr_analysis` 头注 vs 实现 · `SG_FLOW` 无产生点） |
...
### 2026-09-17-16. **【语言面·零语义存量】`move` 关键字删除**（2026-09-17 并发模型规格 **G8 裁定**：维护者裁「删掉」——独立小批）
...
### 2026-09-17-17. ⚠⚠ **【静默·安全网失效】`ptr_analysis` 全程序 alloc 追踪上限 64（第 65 个起静默不追踪）+ 计数器从不复位**（2026-09-17 并发模型规格 **G3 裁定**：先裁「pts 表示升级」；本条为必立的静默缺陷）
...
### 2026-09-17-18. **文档/注释漂移三处**（2026-09-17 并发模型规格 §15.5 实读发现——登记批）
