...
### 93. ⚠ **【崩溃·预存】模块限定调用直接作实参 ⇒ SIGSEGV 139**（2026-09-16 apx 批 T5 实测——**既有缺陷，非本批引入**）
...
- **状态**：**登记，未修**（不属 apx 批范围——本批面 = dex 形式转换；本条目**零 dex**）。**关联**：apx 批计划 §7quinquies 遗留 · `tests/suite/apx_conversion_test.cr` 的 §2 注释（该档已绕开此形）。
